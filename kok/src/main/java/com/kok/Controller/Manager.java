    ...
    public static void enter(int emp_id, int position) throws SQLException {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                switch (reportchoice) {
                    ...
                    case 2: {
                        ...
                        ArrayList<Attendrep> list = AttendanceDBA.TotalReport(dateformatter.format(dt1),
                                dateformatter.format(dt2));
            ...
            case 4: {
                ...
                String rep = "";
                for (int i = 0; i < list.size(); i++) {
                    rep = rep + list.get(i).getName() + " " + list.get(i).getPresentOrNot() + " "
            ...
            case 5: {
                view.addemployeeMenu();
                int aechoice = view.getInt();
                switch (aechoice) {

                    // add employees
                    case 1: {
                        employee e = view.addemployeedetails();
                        boolean temp = Employee_infoDBA.addemployee(e);
                        if (temp == true) {
                            view.print("Employee details added successfully");
                        } else {
                            view.print("Employee details not added error");    
                        }
                        Manager.enter(emp_id, position);
                        System.exit(200);
